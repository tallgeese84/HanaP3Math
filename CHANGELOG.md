...
|-------|------------|--------------|
| h14 | 2026-09-25 | Fixes greyed-out, untappable answers when switching from a completed keypad/stylus question to multiple choice. Every answer renderer now synchronises the shared input lock with the current question. Adds touch regression tests for all three input methods, Next/map transitions, retries, hints, replay and resume; completed answers still cannot award twice. Progress and family audio are unchanged. |
| h13 | 2026-09-25 | Adds 43 visual mini-lessons with worked examples, learning checks and device read-aloud, followed by focused adaptive practice. Three independent answers raise difficulty; two supported answers, repeated mistakes or reveals lower it. Adds automatic recaps and supported lesson replay, real task changes across all 40 automatically checked skill families, saved lesson slides/checks and cloud/backup support. All 62 family recordings remain unchanged. |
| h12 | 2026-09-25 | Mochi-style P3/P4 studio with explicit year selection, 43 mapped skills, six-question sessions, saved thinking notes/drawings, independent/support evidence and delayed review. Adds pie charts and missing geometry/decimal/fraction practice, corrects P3 24-hour time and ambiguous questions, preserves all 62 family clips/rewards, adds keyboard input and local starter artwork, and isolates offline caches from sibling apps. Regression tests cover generated questions and real browser/audio/offline flows. |
