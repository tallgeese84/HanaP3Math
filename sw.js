...
const CACHE = 'pokequest-hana-h14';
const PREFIX = 'pokequest-hana-';
const CORE = ['./','./index.html','./manifest.json','./hana-voice.json','./hana-avatar.png','./digit-net.json','./icon-192.png','./icon-512.png','./studio.css?v=h14','./curriculum.js?v=h14','./learning.js?v=h14','./lessons.js?v=h14','./studio.js?v=h14','./art/1.png','./art/4.png','./art/7.png','./art/25.png','./art/133.png'];
